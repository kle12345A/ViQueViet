...
excerpt: "Chả ốc kết hợp nguyên liệu quen thuộc trong một cách thưởng thức tiện lợi."
weight: "Theo quy cách"
thumbnail: "/images/products/cha-oc/card.webp"
heroImage: "/images/products/cha-oc/hero.webp"
featured: true
bestSeller: false
status: "published"
sortOrder: 16
...
badges:
  - ""
gallery:
  - "/images/products/cha-oc/hero.webp"
  - "/images/products/cha-oc/card.webp"
---
## Giới thiệu

Chả ốc Special thuộc danh mục thực phẩm chế biến của Vị Quê Việt, hướng đến sự tiện lợi và hương vị gần gũi trong bữa ăn Việt.
