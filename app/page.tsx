...
export default function Home() {
  ...
  return <>
    ...
    <section className="section section-green"><div className="container split-grid"><div><SectionHeading align="left" eyebrow="Năng lực sản xuất" title="Không gian sản xuất được phân khu rõ ràng" description="Hình ảnh thực tế cho thấy các khu vực thao tác, đóng gói và thiết bị phục vụ quy trình sản xuất thực phẩm." /><Button href="/nha-may" variant="secondary">Thăm nhà máy</Button></div><div className="split-image"><Image src="/images/factory/production-line.webp" alt="Nhân sự Vị Quê Việt tại khu vực sản xuất" fill sizes="(max-width: 820px) 100vw, 50vw" /></div></div></section>
    <VideoShowcase />
    <PartnerShowcase />
